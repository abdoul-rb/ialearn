<template>
  <main class="font-montserrat">
    ...
    <div class="max-w-full mx-auto mt-12">
      <dl class="rounded-lg bg-gray-50 shadow-lg sm:grid sm:grid-cols-3">
        <div class="flex flex-col border-b border-gray-200 p-6 text-center sm:border-0 sm:border-r">
          <dt id="item-1" class="order-2 mt-2 text-lg leading-6 font-medium text-indigo-600">Unviersités</dt>
          <dd aria-describedby="item-1" class="block flex flex-col items-center justify-center order-1 text-4xl tracking-wider leading-none font-normal text-blue-750">
            <div class="flex-items-center justify-center">
              <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="university" class="fill-current text-indigo-600 h-10 w-10 mb-3" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        <div class="flex flex-col border-t border-b border-gray-200 p-6 text-center sm:border-0 sm:border-l sm:border-r">
          <dt class="order-2 mt-2 text-lg leading-6 font-medium text-indigo-600">Étudiants</dt>
          <dd aria-describedby="item-1" class="block flex flex-col items-center justify-center order-1 text-4xl tracking-wider leading-none font-normal text-blue-750">
            <div class="flex-items-center justify-center">
              <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user-graduate" class="fill-current text-indigo-600 h-10 w-10 mb-3" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
        ...
        <div class="flex flex-col border-t border-gray-200 p-6 text-center sm:border-0 sm:border-l">
          <dt class="order-2 mt-2 text-lg leading-6 font-medium text-indigo-600">Particuliers</dt>
          <dd aria-describedby="item-1" class="block flex flex-col items-center justify-center order-1 text-4xl tracking-wider leading-none font-normal text-blue-750">
            <div class="flex-items-center justify-center">
              <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chalkboard-teacher" class="fill-current text-indigo-600 h-10 w-10 mb-3" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
