        ...
        <div class="relative h-16 flex justify-between">
			<div class="relative z-10 px-1 flex lg:px-0">
          	...
          	<div class="hidden lg:relative lg:z-10 lg:ml-4 lg:flex lg:items-center gap-x-2">
				...
				<nuxt-link :to="{ name : 'forum' }" class="text-white bg-green-900 rounded-md py-2 px-6 inline-flex items-center text-sm font-medium" :class="$route.name === 'forum' ? 'bg-gray-100 text-gray-900': ''">
					S'inscrire
				</nuxt-link>
