<template>
  <div class="">
    <div class="relative">
      <div class="relative z-20 shadow">
        <div class="max-w-7xl mx-auto flex justify-between items-center px-4 py-5 sm:px-6 sm:py-4 lg:px-8 md:justify-start md:space-x-10">
          ...
          <div class="-mr-2 -my-2 md:hidden">
            <button @click.prevent="mobileMenuOpen = !mobileMenuOpen" type="button" class="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
          ...
          <div class="hidden md:flex-1 md:flex md:items-center md:justify-between">
            <nav class="flex space-x-10">
              <div class="relative">
                <button type="button" @click="solutionsMenuOpen = !solutionsMenuOpen; moreMenuOpen = false" :class="{ 'text-gray-900': solutionsMenuOpen, 'text-gray-500': !solutionsMenuOpen }" class="group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 text-gray-900">
                  <span>Solutions</span>
                  <svg class="ml-2 h-5 w-5 group-hover:text-gray-500 text-gray-600" :class="{ 'text-gray-600': solutionsMenuOpen, 'text-gray-400': !solutionsMenuOpen }" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            ...
            <div class="flex items-center space-x-6 md:ml-12">
              ...
              <a href="#" class="inline-flex items-center justify-center px-4 py-2 border border-transparent rounded  text-sm font-medium text-white uppercase bg-indigo-600 hover:bg-indigo-700">
                Contactez-nous
              </a>
            </div>
          </div>
      ...
      <!-- Solutions menu -->
      <div v-show="solutionsMenuOpen" class="hidden md:block absolute z-10 inset-x-0 transform shadow-lg">
        <div class="bg-white">
      ...
      <div v-show="moreMenuOpen" class="hidden md:block absolute z-10 inset-x-0 transform shadow-lg" style="display: none;">
                ...
                <li class="flow-root">
                  <a href="#" class="-m-3 p-3 flex rounded-lg hover:bg-gray-100">
                    ...
                    <div class="w-0 flex-1 sm:ml-8">
                      ...
                      <p class="mt-1 text-sm text-gray-500">Eget ullamcorper ac ut vulputate fames mattis . Viverra tempor id mus.</p>
                    </div>
                  </a>
                </li>
                <li class="flow-root">
                  <a href="#" class="-m-3 p-3 flex rounded-lg hover:bg-gray-100">
                    ...
                    <div class="w-0 flex-1 sm:ml-8">
                      <h4 class="text-base font-medium text-gray-900 truncate">How to use search engine to drive to your site</h4>
                      <p class="mt-1 text-sm text-gray-500">Eget  ac ut vulputate fames nec mattis. Viverra tempor id mus.</p>
                    </div>
                  </a>
                </li>
              </ul>
      ...
      <div v-show="mobileMenuOpen" class="absolute z-10 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
