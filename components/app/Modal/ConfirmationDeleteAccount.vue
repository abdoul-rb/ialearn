<template>
  <app-modal name="ConfirmationDeleteAccount">
    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4" >
      <div class="sm:flex sm:items-start">
        ...
        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
          <h3 class="text-lg">Supprimer mon compte</h3>
          <div class="mt-2">
            Etes-vous sûr de vouloir supprimer votre compte ? Toutes vos informations seront supprimer automatiquement.
          </div>
        </div>
      </div>
    </div>
